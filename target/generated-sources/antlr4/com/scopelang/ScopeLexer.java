...
public class ScopeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "AssemblyBlock", "LeftParen", "RightParen", "LeftBracket", "RightBracket", 
			"LeftBrace", "RightBrace", "Assign", "Pow", "Mul", "Div", "Add", "Sub", 
			"Mod", "Not", "PowAssign", "MulAssign", "DivAssign", "AddAssign", "SubAssign", 
			"ModAssign", "Equals", "NotEquals", "GreaterThan", "LessThan", "GreaterThanEqual", 
			"LessThanEqual", "And", "Or", "Cast", "Where", "Range", "Resolve", "Access", 
			"FuncKeyword", "ImportKeyword", "ReturnKeyword", "BreakpointKeyword", 
			"IfKeyword", "ElseKeyword", "WhileKeyword", "ForKeyword", "StepKeyword", 
			"NamespaceKeyword", "UsingKeyword", "BreakKeyword", "ContinueKeyword", 
	...
	public ScopeLexer(CharStream input) {
		super(input);
